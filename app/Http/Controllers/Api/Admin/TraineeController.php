...
class TraineeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $tasks_count = $assignments->count() + $exams->count();
    ...
    public function excel_sheet_trainees(Request $request)
    {
        ...
        $sheet->setCellValue('D1', __('trans.excel_sheet.program'));
        ...
        $sheet->setCellValue('D2', __('trans.excel_sheet.program_name'));
    ...
    public function store(Request $request)
    {
        ...
        if ($request->student_id) {
            ...
            foreach ($request->programs_id as $programId) {
                $sub = new Subscription();
                $sub->student_id = $request->student_id;
        ...
        $new_noti = new StudentNotificationSetting();
        $new_noti->student_id = $user->id;
        $new_noti->save();
